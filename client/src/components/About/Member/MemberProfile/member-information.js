export default [
  {
    ...
    title: 'CEO/President',
    description:
      'Raymond Lancione is the President and CEO of Qweerty Gamers. Ray has defined his abilities at game developer studios like Nexon and Pearl Abyss with a background in social media, player relations, content creation, and influencer management.In 2018, Ray officially formed Qweerty Gamers, a nonprofit 501(c)(3) with several goals to benefit the LGBTQ community: 1. Provide the local LGBTQ community friendly gaming events, where they can feel comfortable to integrate into the general gaming community. 2. Provide gaming related opportunities or workshops for LGBTQ people and allies for upcoming industry trends (IE. Streaming, Shoutcasting, etc)',
    image: require('../../../../assets/images/member-profile-image/ray.jpeg')
  },
  {
    id: 2,
