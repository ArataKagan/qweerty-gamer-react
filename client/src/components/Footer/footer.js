...
import { faFacebook, faTwitter, faMeetup, faInstagram, faDiscord, faTwitch } from '@fortawesome/free-brands-svg-icons'
        ...
        return(
             <div className={styles['footer']}>
                   <div className="row">
                      <div className="col-md-4 text-center text-md-left">
                                <div className={styles['first-row']}>
                                    ...
                                    <div className="d-flex flex-column bd-highlight mb-3">
                                        <div className="p-2 bd-highlight">© QWEERTY GAMERS 2020. ALL RIGHTS RESERVED.</div>
                      ...
                      <div className="col-md-4 text-center text-md-left" style={{position:"relative"}}>
